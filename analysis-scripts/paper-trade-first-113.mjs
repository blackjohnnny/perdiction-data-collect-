...
// Get FIRST 113 rounds with T-20s data (the original dataset)
const query = `
  SELECT
    epoch,
    lock_ts,
...
console.log(`Paper trading FIRST ${rows.length} rounds (original dataset)...\n`);
...
console.log('═══════════════════════════════════════════════════════════════');
console.log('    PAPER TRADE: FIRST 113 T-20s Rounds (Original Dataset)');
console.log('═══════════════════════════════════════════════════════════════');
...
console.log('📊 PAPER TRADE SUMMARY (FIRST 113 ROUNDS):\n');
...
fs.writeFileSync('../data/paper-trade-first-113.csv', csvLines.join('\n'));
console.log('✅ Trade log saved to: paper-trade-first-113.csv\n');
