...
async function runAdaptiveStrategy(rounds) {
  let wins = 0;
  let losses = 0;
  let skipped = 0;
  let balance = 1.0;
  ...
  for (const round of rounds) {
    ...
    // CORRECTED ADAPTIVE STRATEGY LOGIC
    // Your ORIGINAL strategy (bet WITH crowd) LOSES
    // REVERSE strategy (bet AGAINST crowd) WINS
    if (marketCondition.isConsolidation) {
      // CONSOLIDATION: Use REVERSE (contrarian - bet AGAINST crowd)
      ...
      // TRENDING: Use REVERSE (contrarian - bet AGAINST crowd)
      if (marketCondition.emaSignal === 'BULL' && bullPercent >= CROWD_THRESHOLD) {
        betSide = 'BEAR'; // Crowd bullish → bet BEAR (contrarian)
      } else if (marketCondition.emaSignal === 'BEAR' && bearPercent >= CROWD_THRESHOLD) {
        betSide = 'BULL'; // Crowd bearish → bet BULL (contrarian)
...
async function test() {
  ...
  console.log(`\n🎯 ADAPTIVE STRATEGY - Market Condition Based\n`);
  ...
  console.log(`  📊 CONSOLIDATION → Bet WITH EMA (trend following)`);
  console.log(`  📈 TRENDING → Bet AGAINST EMA (contrarian)\n`);
  console.log(`Testing on ${rounds.length} rounds\n`);
  console.log(`━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n`);

  const result = await runAdaptiveStrategy(rounds);

  console.log(`\n📊 RESULTS:\n`);
  console.log(`Total Trades: ${result.totalTrades}`);
  console.log(`  Consolidation: ${result.consolidationTrades} trades (${result.consolidationWins} wins, ${result.consolidationWinRate}% win rate)`);
  console.log(`  Trending: ${result.trendingTrades} trades (${result.trendingWins} wins, ${result.trendingWinRate}% win rate)`);
  console.log(`\nOverall:`);
  ...
  console.log(`Strategy                                  | Win Rate | ROI`);
  console.log(`━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
  console.log(`🎯 ADAPTIVE (market condition based)      | ${result.winRate.padStart(8)}% | ${result.roi.padStart(8)}%`);
  console.log(`   ├─ Consolidation (bet WITH EMA)        | ${result.consolidationWinRate.padStart(8)}% | -`);
  console.log(`   └─ Trending (bet AGAINST EMA)          | ${result.trendingWinRate.padStart(8)}% | -`);
  console.log(`━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
  console.log(`Always contrarian (bet AGAINST EMA)       |    41.38% |   -59.13%`);
  console.log(`Always trend following (bet WITH EMA)     |    58.62% |    36.31%`);
  console.log(`Pure contrarian (no EMA, 65% crowd)       |    54.89% |   196.38%`);
  console.log(`━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n`);
}
